            ...
            'fields'                => [
                'author'            => '
                    <div class="col_one_third">
                        <label>'. __( 'Name', 'mehdi-stater' ) .'</label>
                        <input type="text" name="author" class="sm-form-control" />
                    </div>',
                'email'             => '
                    <div class="col_one_third">
                        <label>'. __( 'Email', 'mehdi-starter' ) .'</label>
                        <input type="text" name="email" class="sm-form-control" />
                    </div>',
                'url'               => '
                    <div class="col_one_third col_last">
                        <label>'. __( 'Website', 'mehdi-starter' ) .'</label>
                        <input type="text" name="url" class="sm-form-control" />
                    </div>'
            ],
            'class_submit'      => 'button button-3d nomargin',
            'label_submit'      => __( 'Submit Commnet', 'mehdi-starter' ),
            'title_reply'       => __( 'Leave a <span>Comment</span>', 'mehdi-starter' )
        ]);
        ?>
